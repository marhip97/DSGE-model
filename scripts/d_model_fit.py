...
Leveranser:
  data/results/D_modellfit.png     — faktisk vs. filtrert for alle 14 serier
  data/results/D_modellfit.md      — RMSE, R², korrelasjon per serie
  data/results/D_modellfit.json    — numeriske resultater
"""
