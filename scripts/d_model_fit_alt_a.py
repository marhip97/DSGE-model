...
Leveranser:
  data/results/D_modellfit_alt_a.png     — faktisk vs. filtrert for alle 14 serier
  data/results/D_modellfit_alt_a.md      — RMSE, R², korrelasjon per serie
  data/results/D_modellfit_alt_a.json    — numeriske resultater
"""
